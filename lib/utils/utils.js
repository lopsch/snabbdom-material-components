...
function makeKeyValue(key, value) {
  return value ? _defineProperty({}, key, value) : {};
}

var PropsNormalizer = exports.PropsNormalizer = function () {
  function PropsNormalizer(_props, _switches) {
    _classCallCheck(this, PropsNormalizer);

    var props = _props || {};
    var switches = _switches || {};

    var fromClassNames = props['classNames'] ? this._classes(this._fromClassNames([props['classNames']])) : {};
    var fromStyle = props['style'] ? this._classes(this._fromClassNames([(0, _typestyle.style)(props['style'])])) : {};
    var fromProps = props['class'] ? props['class'] : {};
    var fromSwitches = this._fromSwitches(switches, props);
