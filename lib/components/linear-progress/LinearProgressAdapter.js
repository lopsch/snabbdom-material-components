...
var _mdcLinearProgress = require('@material/linear-progress/dist/mdc.linearProgress.min');
...
var LinearProgressAdapter = function (_MaterialAdapter) {
  ...
  function LinearProgressAdapter(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (LinearProgressAdapter.__proto__ || Object.getPrototypeOf(LinearProgressAdapter)).call(this, sel, new _mdcLinearProgress.MDCLinearProgress(elm)));
