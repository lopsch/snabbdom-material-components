...
var FAB = function (_AbstractButton) {
  _inherits(FAB, _AbstractButton);

  function FAB(_props, _children) {
    _classCallCheck(this, FAB);

    var _this = _possibleConstructorReturn(this, (FAB.__proto__ || Object.getPrototypeOf(FAB)).call(this, _props, _children, _styles.STYLE_SWITCHES));
