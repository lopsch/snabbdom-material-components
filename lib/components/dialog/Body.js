...
var Body = function (_MaterialComponent) {
  _inherits(Body, _MaterialComponent);

  function Body(_props, _children) {
    _classCallCheck(this, Body);

    return _possibleConstructorReturn(this, (Body.__proto__ || Object.getPrototypeOf(Body)).call(this, _props, _children, _styles.STYLE_SWITCHES_BODY));
  }
