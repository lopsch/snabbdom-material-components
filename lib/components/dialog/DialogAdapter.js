...
var _mdcDialog = require('@material/dialog/dist/mdc.dialog.min');
...
var DialogAdapter = function (_MaterialAdapter) {
  ...
  function DialogAdapter(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (DialogAdapter.__proto__ || Object.getPrototypeOf(DialogAdapter)).call(this, sel, new _mdcDialog.MDCDialog(elm)));
