...
var SupportingText = function (_MaterialComponent) {
  _inherits(SupportingText, _MaterialComponent);

  function SupportingText() {
    _classCallCheck(this, SupportingText);

    return _possibleConstructorReturn(this, (SupportingText.__proto__ || Object.getPrototypeOf(SupportingText)).apply(this, arguments));
  }

  _createClass(SupportingText, [{
    key: 'render',
    value: function render() {
      return (0, _snabbdomJsxPragma2.default)(
        'section',
        _extends({}, this.selector, {
          classNames: _styles.ST_CLASS,
          'class': this.classes
        }, this.props),
        this.children
      );
