...
var Primary = function (_MaterialComponent) {
  _inherits(Primary, _MaterialComponent);

  function Primary() {
    _classCallCheck(this, Primary);

    return _possibleConstructorReturn(this, (Primary.__proto__ || Object.getPrototypeOf(Primary)).apply(this, arguments));
  }
    ...
    value: function render() {
      return (0, _snabbdomJsxPragma2.default)(
        ...
        _extends({}, this.selector, {
          classNames: _styles.PRIMARY_CLASS,
          'class': this.classes
        }, this.props),
        this.children
      );
