...
var MediaItem = function (_MaterialComponent) {
  _inherits(MediaItem, _MaterialComponent);

  function MediaItem(_props, _children) {
    _classCallCheck(this, MediaItem);

    var _this = _possibleConstructorReturn(this, (MediaItem.__proto__ || Object.getPrototypeOf(MediaItem)).call(this, _props, _children, _styles.STYLE_SWITCHES_MEDIA_ITEM));

    var _this$props = _this.props,
        src = _this$props.src,
        otherProps = _objectWithoutProperties(_this$props, ['src']);

    _this.src = _this.utils.makeKeyValue('src', src);
    ...
    value: function render() {
      return (0, _snabbdomJsxPragma2.default)(
        ...
        _extends({}, this.selector, {
          classNames: _styles.MEDIA_ITEM_CLASS,
          'class': this.classes
        }, this.src, this.props),
        this.children
      );
